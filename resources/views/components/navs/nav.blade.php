<nav class=" bg-input max-w-[250px] h-[100vh] relative bottom-0 left-0 top-0">
    <ul>
        ...
        <li class="nav-item">
            <a href="{{route("usuarios.create")}}" class="{{request()->routeIs('usuarios.*') ? "item-active" : ""}}">
                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 520 520"  preserveAspectRatio="xMaxYMax meet">
