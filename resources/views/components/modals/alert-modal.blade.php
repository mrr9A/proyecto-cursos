<div id="{{ $id }}" tabindex="-1"
    ...
    <div class="relative w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 ">
                <svg aria-hidden="true" class="mx-auto mb-4 text-orange-400 w-14 h-14 dark:text-gray-200" fill="none"
                ...
                <div class="flex gap-2 flex-grow justify-center">
                    ...
                    <button data-modal-hide="{{ $id }}" type="button"
                        class="text-white bg-primary hover:bg-primary-light focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-white focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">No,
                        Cancelar
                    </button>
                </div>
            </div>
