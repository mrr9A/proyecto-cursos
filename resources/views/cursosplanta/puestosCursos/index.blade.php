        ...
        <div class="flex">
            <div class="flex flex-col">
                ...
                <select name="puesto_id" id="puestos"
                    class="py-2 px-3 text-sm leading-tight uppercase border-none focus:outline-none focus:ring-0">
            ...
            <div class="flex flex-col">
                <p>trabajos</p>
                <div id="content-works" class=""></div>
            </div>
        </div>
        <section class="bg-gray-light rounded-md py-2 px-4">
            <span class="text-sm">Si el puesto tiene trabajos, puede seleccionar uno o mas trabajos y los cursos a
                asignar en caso de que compartan cursos</span>
        </section>
