<x-app title="Crear Usuario">
    <form method="POST" action="{{ route('usuarios.store') }}" class="w-[400px] flex flex-col gap-2 p-4 rounded">
        ...
        <x-input-text text="Apellido Paterno" nombre="apellido_paterno" placeholder="apellido paterno" />
        <x-input-text text="Apellido Materno" nombre="apellido_materno" placeholder="apellido materno" />

        <x-input-select :puestos=$puestos />

        <div id="trabajos" class=""></div>
