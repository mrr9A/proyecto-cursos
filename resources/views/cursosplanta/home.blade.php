            ...
            <div class="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                ...
                <div>
                    <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        @else
                            <a href="{{ $data['links']['paginator']->previousPageUrl() }}" aria-label="@lang('pagination.previous')"
                                class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                <span class="sr-only">Previous</span>
                                <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd"
                        ...
                        @if ($data['links']['paginator']->currentPage() != 1)
                            <a href="{{ $data['links']['paginator']->url(1) }}" class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">1</a>
                        @endif
                        ...
                        @if ($data['links']['paginator']->currentPage() != $data['links']['paginator']->lastPage())
                            ...
                            <a href="{{ $data['links']['paginator']->url($data['links']['paginator']->lastPage())}}" class="relative inline-flex items-center rounded-r-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">{{$data['links']['paginator']->lastPage()}}</a>
                        @endif

                        <!-- Enlace a la siguiente página -->
                        @if ($data['links']['paginator']->hasMorePages())
                            <a href="{{ $data['links']['paginator']->nextPageUrl() }}" aria-label="@lang('pagination.next')"
