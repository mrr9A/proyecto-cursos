<div>
    ...
    <div class="w-full p-4 border-gray-200 rounded-lg px-44 dark:bg-gray-800 dark:border-gray-700 {{ $currentStep != 1 ? 'displayNone' : '' }}" id="step-1">
        ...
        <div class="px-4">
            ...
            <button class="text-white bg-btn-primary hover:bg-btn-primary-light focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700" wire:click="firstStepSubmit" type="button" require>
