                    ...
                    <div class="col-12">
                        <div class="col-12 mx-6">
                            ...
                            <div class="grid col-4">
                                <label for="nombre" class="font-bold">Nombre del Contenido <span
                                        class="text-red-500">*</span></label>
                                <input type="text" value="{{ old('nombre') }}" rows="3" name="nombre"
                            ...
                            <div class="grid col-11">
                                <label for="descripcion" class="font-bold">Descripcion del Contenido <span
                                        class="text-red-500">*</span></label>
                                <textarea type="text" rows="8" name="descripcion"
                                    class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <br>
                            <label for="cover-photo" class="font-bold">Archivo del Contenido <span
                                    class="text-red-500">*</span></label>
                            <div
                                class="col-11 col-11 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                <div
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="mt-4 flex text-sm items-center text-center leading-6 text-gray-600"
                                            ...
                                            <label for="file-upload"
                                                class="bg-gray-50 border items-center border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
