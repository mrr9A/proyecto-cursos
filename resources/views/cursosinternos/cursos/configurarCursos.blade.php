<x-app title="Cursos:">
    <nav class="mx-4">
        <a href="{{url('curs')}}" class="text-base text-nav-hover font-bold">Catalago de cursos > </a>
        ...
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownButton1">
                        <li class="justify-center">
                            <form action="{{url('Lecciones',[$curso])}}">
                                <button class="block pl-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-400 dark:hover:text-white">Agregar una lección</button>
                            </form>
                        </li>
                        <li>
                            @if(count($curso->examen) > 0 )
                            <form action="{{url('examenes',[$curso->examen[0]->id_examen])}}" method="POST" id="" class="text-secondary formulario-eliminarEx pl-2">
                                @method("DELETE")
                                @csrf
                                <button class="block  py-2 hover:bg-gray-100 text-incompleted dark:hover:bg-gray-600 dark:hover:text-white">Eliminar examen final</button>
                            </form>
                            <a href="{{route('verExFinalMedit',$curso->id_curso)}}" class="block pl-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                                <span class="text-center">Editar examen final</span>
                            </a>
                            @else
                            <form action="{{  route('newExamen',[$curso]) }}">
                                <button class="block  py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Agregar examen final</button>
                            </form>
                            @endif
                        </li>
                        <li>
                            <button data-modal-target="editar_curso_interno" data-modal-toggle="editar_curso_interno" class="block pl-2 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white" type="button">
            ...
            <div class="p-2  border border-gray-200 rounded-lg shadow mx-12 text-center">
                <div class="text-center">
                    ...
                    <h3 class="text-section-subtitle font-bold tracking-tight text-gray-600">Codigo: <span class="text-nav-hover">{{$curso->codigo}}</span></h3><br>
                    <h5 class="text-section-subtitle font-bold tracking-tight text-gray-600">Modalidad:
                    ...
                    <h5 class="text-section-subtitle font-bold tracking-tight text-gray-600">Tipo:
                        @foreach($tipo as $tip)
                    ...
                    <h5 class="text-section-subtitle font-bold tracking-tight text-gray-600">Categoria:
            ...
            <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                ...
                <h2 id="accordion-color-heading-{{$leccion->id_leccion}}" class="col-lg-12 mb-6 mb-lg-0 position-relative">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-medium text-left text-gray-500 border border-b-0 border-gray-200 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-color-body-{{$leccion->id_leccion}}" aria-expanded="true" aria-controls="accordion-color-body-{{$leccion->id_leccion}}">
                        ...
                        <span class="text-subtitle text-lg italic">LECCIÓN : <span>{{$leccion->nombre}}</span></span>
                            ...
                            <div class="flex justify-between px-4 items-center overflow-auto gap-3">
                                ...
                                <div class="flex overflow-auto gap-3 items-center">
                                    ...
                                    <a href="{{url('examenes',[$conteni])}}">
                                        ...
                                        <span class="text-center">Agregar examen</span>
                                    </a>
                                    @endif
