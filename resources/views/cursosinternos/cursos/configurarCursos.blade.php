<x-app title="Cursos:">
    <nav class="mx-4 flex justify-between items-center">
        ...
        <div class="justify-end">
            <button data-modal-target="ayuda_curso" data-modal-toggle="ayuda_curso"
                class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white boton_modal"
                type="button">
    ...
    <div class="flex">
        ...
        <div
            class="w-full p-4 border border-gray-200 rounded-lg shadow sm:p-6 md:p-4 dark:bg-gray-800 dark:border-gray-700">

            <div id="accordion-color" data-accordion="collapse"
                data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                @if (count($curso->lecciones) > 0)
                    @foreach ($curso->lecciones as $leccion)
                        <h2 id="accordion-color-heading-{{ $leccion->id_leccion }}"
                            class="col-lg-12 mb-6 mb-lg-0 position-relative">

                            <div class="flex w-full overflow-auto gap-3 justify-between p-5 font-medium text-left text-gray-500 border  border-gray-300 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800"
                                type="button" data-accordion-target="#accordion-color-body-{{ $leccion->id_leccion }}"
                                aria-expanded="false" aria-controls="accordion-color-body-{{ $leccion->id_leccion }}">
                                <div class="flex justify-center overflow-auto gap-2">
                                    <span><img src="{{ $leccion->url_imagen }}" width="50" height="50"
                                            alt="Imagen"></span>
                                    <span class="text-subtitle px-4 text-lg italic">LECCIÓN :
                                        {{ $leccion->nombre }}</span>
                                </div>
                                <div class="justify-end">
                                    <button>
                        ...
                        <div id="accordion-color-body-{{ $leccion->id_leccion }}" class="hidden"
                            aria-labelledby="accordion-color-heading-{{ $leccion->id_leccion }}">
                            <div
                                class="border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900 col-lg-12 mb-6 mb-lg-0 position-relative">
                                <div
                                    ...
                                    <h5
                                        ...
                                        DESCRIPCIÓN DE LA LECCIÓN:</h5>
                                    <p>{{ $leccion->descripcion }}</p>
                                </div><br>
                                <div
                                    class="flex justify-between px-4 items-center overflow-auto gap-3 mb-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                                    <div
                                        class="p-1 px-60 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 text-center font-bold  text-nav-hover mb-2 items-center tracking-tight dark:text-white">
                                        CONTENIDOS DE LA LECCIÓN:
                                    </div>
                                    <!-- OPCIONES -->
                                    <div class="flex justify-end px-4">
                                        <button id="dropdownButton3-{{ $leccion->id_leccion }}"
                                            data-dropdown-toggle="dropdown3-{{ $leccion->id_leccion }}"
                                            class="flex items-center text-input font-bold dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-1.5"
                                            type="button">
                                            <span>Opciones</span>
                                        ...
                                        <!-- Dropdown menu -->
                                        <div id="dropdown3-{{ $leccion->id_leccion }}"
                                            class="z-10 hidden bg-blue-50 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-100">
                                            <ul class="py-2"
                                                aria-labelledby="dropdownButton3-{{ $leccion->id_leccion }}">
                                                <li>
                                                    @if (count($usuariosS) > 0)
                                                    @else
                                                        <a href="{{ url('contenidos', [$leccion]) }}"
                                                            class="block px-4 py-2 hover:bg-gray-100 text-sm dark:hover:bg-gray-600 dark:hover:text-white">
                                                            Agregar contenido
                                                        </a>
                                                    @endif
                                                </li>
                                                <li>
                                                    <a href="{{ route('editLec', [$leccion]) }}"
                                                        class="block px-4 py-2 hover:bg-gray-100 text-sm dark:hover:bg-gray-600 dark:hover:text-white">
                                                        Editar leccion
                                                    </a>
                                                </li>
                                                <li>
                                                    <form action="{{ url('Lecciones', [$leccion]) }}" method="POST"
                                                        class="formulario-eliminar">
                                                        @method('DELETE')
                                                        @csrf
                                                        <button type="submit"
                                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 text-sm text-incompleted dark:hover:text-white">
                                                            Eliminar lección
                                                        </button>
                                                    </form>
                                                </li>
                                ...
                                @foreach ($leccion->contenido as $conteni)
                                    <div
                                        class="border-top px-2 py-3 mx-4 min-height-70 d-md-flex align-items-center bg-blue-50 col-lg-11 mb-6 mb-lg-0">
                                        <div class="flex justify-between px-4 items-center overflow-auto gap-3">
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                                    viewBox="0 0 20 20">
                                                    <path fill="currentColor"
                                                        d="M10 2c4.42 0 8 3.58 8 8s-3.58 8-8 8s-8-3.58-8-8s3.58-8 8-8zm0 14c3.31 0 6-2.69 6-6s-2.69-6-6-6s-6 2.69-6 6s2.69 6 6 6zm-.71-5.29c.07.05.14.1.23.15l-.02.02L14 13l-3.03-3.19L10 5l-.97 4.81h.01c0 .02-.01.05-.02.09S9 9.97 9 10c0 .28.1.52.29.71z" />
                                                </svg>
                                            </span>
                                            ...
                                            <div class="flex overflow-auto gap-3 items-center">
                                                    ...
                                                    <a href="{{ url('examenes', [$conteni]) }}"
                                                        ...
                                                        <span class="text-center items-center">
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                                ...
                                                                <g fill="currentColor">
                                                                    <path
                                                                        d="M20 15a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1Zm1 3a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-8Zm-1 10a1 1 0 0 1 1-1h8a1 1 0 1 1 0 2h-8a1 1 0 0 1-1-1Zm1 3a1 1 0 1 0 0 2h8a1 1 0 1 0 0-2h-8Z" />
                                                                    <path fill-rule="evenodd"
                                                                    ...
                                                                    <path fill-rule="evenodd"
                                                                        d="M10 6a4 4 0 0 0-4 4v28a4 4 0 0 0 4 4h20a4 4 0 0 0 4-4V10a4 4 0 0 0-4-4H10Zm-2 4a2 2 0 0 1 2-2h20a2 2 0 0 1 2 2v28a2 2 0 0 1-2 2H10a2 2 0 0 1-2-2V10Zm28 6a3 3 0 1 1 6 0v20.303l-3 4.5l-3-4.5V16Zm3-1a1 1 0 0 0-1 1v2h2v-2a1 1 0 0 0-1-1Zm0 22.197l-1-1.5V20h2v15.697l-1 1.5Z"
                                                                        clip-rule="evenodd" />
                                                                </g>
                                                            </svg>
                                                        </span>
                                                ...
                                                @endif
                                                <button id="dropdownButto-{{ $conteni->id_contenido }}"
                                                    data-dropdown-toggle="dropdow-{{ $conteni->id_contenido }}"
                                                    class="flex items-center text-input font-bold dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-1.5"
                                                    type="button">
                                                    <span class="justify-end">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="26"
                                                ...
                                                <div id="dropdow-{{ $conteni->id_contenido }}"
                                                    class="z-10 hidden bg-blue-50 divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-100">
                                                    <ul class="py-2"
                                                        aria-labelledby="dropdownButto-{{ $conteni->id_contenido }}">
                                                        <li class="flex justify-between items-center">
                                                            <form action="{{ url('contenidos', [$conteni]) }}"
                                                                method="POST" id="{{ $conteni->nombre }}"
                                                                class="block text-secondary formulario-eliminarCont px-4 py-2 hover:bg-gray-100 text-sm dark:hover:bg-gray-600 dark:hover:text-white">
                                                                @method('DELETE')
                                                                @csrf
                                                                <button type="submit"
                                                                    class="btn py-4 text-red-500 text-center">
                                                            ...
                                                            <a href="{{ route('ediConte', [$conteni]) }}"
                                                                ...
                                                                <span>
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        ...
                                                                        <path
                                                                            d="M40.561,11.987c0.586,0.586,0.586,1.536,0,2.121L15.488,39.181l-5.292,1.77c-0.709,0.237-1.384-0.438-1.147-1.147	l1.77-5.292L35.892,9.439c0.586-0.586,1.536-0.586,2.121,0L40.561,11.987z M33.274,13.294L11.583,34.985l-1.058,3.164l1.325,1.325	l3.165-1.058l21.691-21.691L33.274,13.294z">
                                                                        </path>
                                                                    </svg>
                                                                </span>
                                                        ...
                                                        <li class="flex justify-between items-center">
                                                            @if (count($conteni->examen) > 0)
                                                                <form
                                                                    action="{{ url('examenes', [$conteni->examen[0]->id_examen]) }}"
                                                                    method="POST" id="{{ $conteni->nombre }}"
                                                                    class="block px-4 py-2 hover:bg-gray-100 text-sm dark:hover:bg-gray-600 dark:hover:text-white text-secondary formulario-eliminarEx">
                                                                    @method('DELETE')
                                                                    @csrf
                                                                    <button type="submit" class="btn text-center">
                                                                        ...
                                                                        <span
                                                                            class="text-center text-sm text-red-500">Eliminar
                                                                            examen</span><br>
                                                                    </button>
                                                                </form>
                                                                <a href="{{ route('editExamen', $conteni) }}"
                                                                    class="block px-4 py-2 hover:bg-gray-100 text-sm dark:hover:bg-gray-600 dark:hover:text-white">
                                                                    <span class="text-center">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            width="26" height="26"
                                                                    ...
                                                                    <span class="text-center text-sm">Editar
                                                                        examen</span>
                                                                </a>
                                                            @endif
                                                        </li>
                ...
                @else
                    <div
                        class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 items-center text-center">
                        <h2 class="text-subtitle font-bold tracking-tight text-gray-900">BIENVENIDO</h2>
                        <h5 class="text-start px-12 justify-start font-bold text-gray-600"><span>Siga los siguientes
                                pasos para crear las lecciones, contenidos y examenes correctamente del curso:</span>
                        </h5>
                        ...
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 2: Seleccione la opción agregar una
                            lección.</h1>
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 3: Una vez creada la lección, abra la
                            lección y de clic en opciones.</h1>
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 4: Seleccione la opción agregar contenido.
                        </h1>
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 5: Una vez creado el contenido, de clic en
                            agregar examen para asignar un examen al contenido</h1>
                        <h1 class="mt-1 flex justify-start px-12 text">tenga en cuenta que el examen es obligatorio.
                            <span class="text-red-700">*</span>
                        </h1>
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 6: Para asignar el examen final de clic en
                            el siguiente icono en información general.
                            <span class="px-2 justify-start items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
                                    viewBox="0 0 32 32">
                                    <path fill="#40535b"
                        ...
                        <h1 class="mt-2 flex justify-start px-12 text">Paso 7: Seleccione la opción agregar examen
                            final.</h1>
                        <h3 class="text mt-3 uppercase font-bold px-8 justify-start tracking-tight text-gray-900">Nota:
                        </h3><span class=" font-bold text-red-700 justify-start px-8"> Asegúrese de crear correctamente
                            todas las lecciones y contenidos con su respectivo examen y examen final que tendrá el curso
                            antes de agregar a los usuarios correspondientes</span>
                    </div>
                @endif
            </div>
            @if (count($curso->examen) > 0)
                <div id="accordion-color" data-accordion="collapse"
                    ...
                    <h2 id="accordion-color-heading-0">
                        <button type="button"
                            class="flex items-center justify-between w-full p-3 font-medium text-left text-gray-500 border border-gray-400 rounded-t-xl focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800"
                            data-accordion-target="#accordion-color-body-0" aria-expanded="false"
                            aria-controls="accordion-color-body-0">
                            <span class="px-7">
                        ...
                        <div
                            ...
                            <div class="flex justify-between px-4 items-center overflow-auto gap-3">
                                <div
                                    ...
                                    <h5
                                        class="mb-2 text-2xl font-bold tracking-tight text-center text-gray-900 dark:text-white">
                                        DESCRIPCIÓN DEL CURSO:</h5>
                                    <p>Este es el examen final del curso: <span
                                            class="font-bold">{{ $curso->nombre }}</span> este examen tiene un valor
                                        del <span class="font-bold">40%</span> de la calificación final del curso.</p>
                                </div>
                            </div><br>
        ...
        <div
            class="w-full max-w-md border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div
                        ...
                        <div class="flex justify-end">
                            <button id="dropdownButton1" data-dropdown-toggle="dropdown1"
                                class="flex items-center text-input font-semi-bold dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-1.5"
                                type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    viewBox="0 0 32 32">
                                    <path fill="#40535b"
                            ...
                            <div id="dropdown1"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li class="justify-center">
                                        ...
                                        @else
                                            <form action="{{ url('Lecciones', [$curso]) }}">
                                                <button
                                                    class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-400 dark:hover:text-white">Agregar
                                                    una Lección</button>
                                            </form>
                                        @endif
                                    </li>
                                    <li>
                                        @if (count($curso->examen) > 0)
                                            <form action="{{ url('examenes', [$curso->examen[0]->id_examen]) }}"
                                                method="POST" id=""
                                                class="text-secondary formulario-eliminarEx">
                                                @method('DELETE')
                                                @csrf
                                                <button
                                                    class="block px-4 py-2 hover:bg-gray-100 text-incompleted dark:hover:bg-gray-600 dark:hover:text-white">Eliminar
                                                    Examen Final</button>
                                            </form>
                                            <a href="{{ route('verExFinalMedit', $curso->id_curso) }}"
                                    ...
                                    <li>
                                        <button data-modal-target="editar_curso_interno"
                                            data-modal-toggle="editar_curso_interno"
                                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white boton_modal"
                                            type="button">
                        ...
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary items-center flex icon-uxs">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                    ...
                                    <g fill="currentColor">
                                        <path
                                            d="M15 32a1 1 0 1 0 0 2h18a1 1 0 1 0 0-2H15Zm-1 5a1 1 0 0 1 1-1h12a1 1 0 1 1 0 2H15a1 1 0 0 1-1-1Z" />
                                        <path fill-rule="evenodd"
            ...
            <div
                class="block p-6 border  border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div
                    class="flex justify-between px-4 items-center overflow-auto gap-3 mb-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    Usuarios inscritos al curso
                    <!-- OPCIONES -->
                    <div class="flex justify-end">
                        <button data-modal-target="agregar_usuario_curso_interno"
                            data-modal-toggle="agregar_usuario_curso_interno"
                            class="flex items-center text-input font-semi-bold dark:text-gray-400 hover:bg-gray-300 dark:hover:bg-gray-700 focus:ring-4 focus:outline-none boton_modal focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg p-1.5"
                            type="button">
                            <span class="justify-end">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                    viewBox="0 0 24 24">
                                    <path fill="none" stroke="#01245a" stroke-linecap="round"
                                        stroke-linejoin="round" stroke-width="2"
                                        d="M15 19c0-2.21-2.686-4-6-4s-6 1.79-6 4m16-3v-3m0 0v-3m0 3h-3m3 0h3M9 12a4 4 0 1 1 0-8a4 4 0 0 1 0 8Z" />
                                </svg>
                            </span>
                        </button>
                    </div>
                ...
                <form class="flex items-center" action="{{ route('curs.show', $curso->id_curso) }}" method="GET">
                    ...
                    <div class="relative w-full">
                        ...
                        <input type="text" id="simple-search" name="buscar1"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Buscar usuario por nombre..." required>
                    </div>
                    <button type="submit"
                            ...
                            <tbody>
                                @if ($resultados2)
                                    ...
                                    @foreach ($resultados2 as $resultado)
                                        <tr
                                            class=" border-b dark:bg-gray-800 text-sm dark:border-gray-800 text-center">
                                            <td class="py-4 font-bold">
                                                {{ $resultado->id_sgp }}
                                            </td>
                                            <td class="py-4 px-2 font-bold">
                                                {{ $resultado->nombre }} {{ $resultado->segundo_nombre }}
                                            ...
                                            <td class="py-4 font-bold">
                                                <div>
                                                    ...
                                                    <input type="date" id="fecha_termino" name="fecha_termino"
                                                        @foreach ($curso->usuarioCurso as $userCurso) @if ($userCurso->id_usuario == $resultado->id_usuario) value="{{ $userCurso->pivot->fecha_termino ?? '' ? date('Y-m-d', strtotime($userCurso->pivot->fecha_termino ?? '')) : '' }}" @endif @endforeach
                                            ...
                                            <td class="py-4 font-bold">
                                                <form action="{{ route('destroyuser', [$resultado]) }}"
                                ...
                                @else
                                    @foreach ($usuariosS as $userCurso)
                                        <tr
                                            ...
                                            <td class="py-4 px-2 font-bold">
                                                {{ $userCurso->nombre }} {{ $userCurso->segundo_nombre }}
                                                {{ $userCurso->apellido_paterno }} {{ $userCurso->apellido_materno }}
                                            </td>
                                            <td class="py-4 font-bold">
                                                <div>
                                                    <label for="fecha_termino"
                                            ...
                                            <td class="py-4 font-bold">
                                                <form action="{{ route('destroyuser', [$userCurso]) }}"
                                                    method="POST" class="formulario-eliminar-User">
                                                    @method('DELETE')
                                                    @csrf
                                                    <button
                    ...
                    $usuariosS->total(): Devuelve el total de resultados obtenidos. --}}
                            ...
                            <div>
                                <nav class="isolate inline-flex -space-x-px rounded-md shadow-sm"
                                    ...
                                    @else
                                        <a href="{{ $usuariosS->previousPageUrl() }}" aria-label="@lang('pagination.previous')"
                                            class="relative inline-flex items-center rounded-l-md px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0">
                                            <span class="sr-only">Previous</span>
                                            <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"
                                                aria-hidden="true">
...
@endif -->
                                    ...
                                    @if ($usuariosS->hasMorePages())
                                        <a href="{{ $usuariosS->nextPageUrl() }}" aria-label="@lang('pagination.next')"
    ...
    <x-modal-prueba title="Agregar usuario al curso" textButton="Agregar Usuarios" id="agregar_usuario_curso_interno"
        vistaContenidoModal="cursosinternos.cursos.agregarUsuarioCurso" :curso="$curso" :usuarios="$usuarios"
        :tipo="$tipo" />
    <x-modal-prueba title="EDITAR CURSO" textButton="Editar Información Curso" id="editar_curso_interno"
        vistaContenidoModal="cursosinternos.cursos.editarCurso" :curso="$curso" :modalidad="$modalidad" :categoria="$categoria"
        :tipo="$tipo" />
    <x-modal-prueba title="PASOS PARA CREAR LECCIONES, CONTENIDO, EXÁMENES" textButton="Hecho" id="ayuda_curso"
        vistaContenidoModal="cursosinternos.cursos.ayuda" class="w-[60%] max-w-full" />
</x-app>
