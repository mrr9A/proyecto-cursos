        ...
        <div class="col-lg-8 mb-6 mb-lg-0 position-relative">
            <div class="card p-5">
                <div class="card mx-12">
                    <img src="{{$curso['imagen']}}" class="card text-center img-responsive" width="350" height="350">
                </div>
                <br>
                <div class="card-header text-center">
                    <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Nombre del Curso: {{$curso->nombre}}</h2><br>
                    <h3 class="text-1xl font-bold tracking-tight text-dark-500 sm:text-2xl">Codigo del Curso: {{$curso->codigo}}</h3><br>
                    <h5 class="text-1xl font-bold tracking-tight text-gray-600 sm:text-2">Modalidad del Curso:
                ...
                <button class="btn btn-dark col-12" data-op="1" data-bs-toggle="modal" data-bs-target="#modalSucursales">Editar</button>
                <form action="{{ url('Lecciones',[$curso]) }}">
                    <button class="btn btn-dark col-12">Agregar una Lección</button>
                </form>
            </div> <br>
            <!-- Cuerpo de las Lecciones -->
            <!-- ==================================================================================================== -->
            <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                ...
                <div id="accordion-color-body-{{$leccion->id_leccion}}" class="hidden" aria-labelledby="accordion-color-heading-{{$leccion->id_leccion}}">
                    <div class="p-2 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900 col-lg-12 mb-6 mb-lg-0 position-relative">
                        <!-- OPCIONES -->
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h6 class="m-0 fw-bolder text-primary text-uppercase"></h6>
                            <div class="dropdown float-end">
                                <button style="width: 100px;" class="btn bg-dark" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <span class="text-center text-white">Opciones</span>
                                </button>
                                <ul class="dropdown-menu text-center btn-sm" aria-labelledby="dropdownMenuButton1">
                                    <a href="{{ url('contenidos',[$leccion]) }}" class="text-dark">Agregar Contenido</a>
                                    <br>
                                    <a href="" class="text-dark">Editar Leccion</a>
                                    <br>
                        ...
                        <!-- FIN -->
                        <!-- <h5>contenido de cada leccion</h5> -->
                        ...
                        <div class="border-top px-2 py-3 mx-4 min-height-70 d-md-flex align-items-center bg-gray-100 col-lg-11 mb-6 mb-lg-0">
                            ...
                            <div class="flex items-end overflow-auto gap-3">
            ...
            <!-- ----------- Fin del cuerpo de las secciones----------------- -->
        </div>
        <!-- CARD DE LA INFORMACION GENERAL DEL CURSO -->
        <div class="col-lg-4">
            <!-- SIDEBAR FILTER
                ================================================== -->
            <div class="card">
            ...
            <!-- Cuerpo de los usuarios inscritos -->
            <div class="card">
                <div class="pt-5 pb-4 px-5 px-lg-3 px-xl-5">
...
<div class="modal fade" id="modalSucursales" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog z-100">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Actualizar Curso</h5>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="nombres">Codígo del Curso</label>
                                    <input type="text" id="codigo" name="codigo" value="{{$curso->codigo}}" class="form-control" placeholder="Laravel" required>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="form-control-label" for="nombres">Nombre del Curso</label>
                                    <input type="text" id="nombre" name="nombre" value="{{$curso->nombre}}" class="form-control" placeholder="Laravel" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label class="form-control-label" for="apellidos">Imagen del Curso</label>
                                    <img src="{{$curso->imagen}}" alt="Author" class="" width="150" height="150">
                                    <br>
                                    <input type="file" id="imagen" accept="image/*" class="bg-dark" value="{{$curso->imagen}}" name="imagen" class="form-control">
                                </div>
                            </div>
                        </div>
                        <!-- Address -->
                        ...
                        <div>
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="font-bold tracking-tight text-gray-900">Fecha de Inicio: {{$curso->fecha_inicio}}</h3>
                                </div>
                                <div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h3 class="font-bold tracking-tight text-gray-900">Fecha de Termino: {{$curso->fecha_termino}}</h3>
                                </div>
                                <div>
                                    <input type="date" name="fecha_inicio" value="{{$curso->fecha_termino}}">
                                </div>
                            </div>
                        </div>
                    </div>
                    <br>
                    <div class="">
                        <button type="button" id="btnCerrar" class="btn bg-dark text-white" data-bs-dismiss="modal">
