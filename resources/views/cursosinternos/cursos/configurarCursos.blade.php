<x-app title="Cursos:">
                    ...
                    <ul class="list-group list-group-flush">
                        ...
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary items-center flex icon-uxs">
                                ...
                                <span>{{$curso->fecha_inicio ?? '' ?  date('Y-m-d', strtotime($curso->fecha_inicio ?? '')) : '' }}</span>
                            </div>
                        </li>
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary items-center flex icon-uxs">
                                ...
                                <span>{{$curso->fecha_termino ?? '' ?  date('Y-m-d', strtotime($curso->fecha_termino ?? '')) : '' }}</span>
                            </div>
                        </li>
                        <li class="list-group-item d-flex align-items-center py-3">
                            <div class="text-secondary items-center flex icon-uxs">
            ...
            <div class="block p-6 border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                <div class="flex justify-between px-4 items-center overflow-auto gap-3 mb-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                    ...
                    <div class="flex justify-end">
                        ...
                        <!-- Dropdown menu -->
                        <div id="dropdown1" class=" hidden text-base list-none  divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            <ul class="py-2" aria-labelledby="dropdownButton1">
                                ...
                                <li>
                                    <!-- Modal toggle -->
                                    <button data-modal-target="eliminar_usuario_curso_interno" data-modal-toggle="eliminar_usuario_curso_interno" class="block text-gray-50 bg-red-600 border-b-2 border-2 rounded-md  focus:outline-none  font-medium text-sm px-5 py-2.5 text-center hover:bg-red-500 hover:text-gray-200 hover:rounded-t-md" type="button"> Eliminar a varios Usuarios del Curso
                                    </button>
    ...
    <x-modal-prueba title="Eliminar a varios Usuarios" textButton="Eliminar Usuarios" id="eliminar_usuario_curso_interno" vistaContenidoModal="cursosinternos.cursos.eliminarUsuarioCurso" :curso="$curso" :usuarios="$curso->usuarioCurso" :tipo="$tipo" />
