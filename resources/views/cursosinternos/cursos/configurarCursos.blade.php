<x-app>
    ...
    <div class="flex">
        ...
        <div class="w-full p-4  border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
            <!-- OPCIONES -->
            ...
            <div class="p-2  border border-gray-200 rounded-lg shadow mx-12 text-center">
                <img src="{{$curso['imagen']}}" class="rounded-full w-96 h-96 inline-block object-cover">
            </div>
            <div class="p-2  border border-gray-200 rounded-lg shadow mx-12 text-center">
                <div class="text-center">
                    <h2 class="text-subtitle font-bold tracking-tight text-gray-900">Nombre del Curso: {{$curso->nombre}}</h2><br>
                    <h3 class="text-section-subtitle font-bold tracking-tight text-gray-600">Codigo del Curso: {{$curso->codigo}}</h3><br>
...
@endif
@if (session('agregado') == 'Contenido Actualizada Correctamente')
<script>
    Swal.fire(
