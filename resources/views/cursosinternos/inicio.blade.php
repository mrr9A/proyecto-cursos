<x-app>
    ...
    <!-- Estadistica de cuantos cursos activos hay -->
    <div>
        <div class="container-fluid pt-3">
            <div class="row removable">
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Cursos Activos</p>
                ...
                <!-- Estadistica de cuantas categorias existen  -->
                <div class="col-xl-3 col-sm-6">
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Categoria por Cursos</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            23
                                        </h5>
                                    </div>
                ...
                <!-- Estadistica de cuantos Usuarios hay-->
                <div class="col-xl-3 col-sm-6">
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <p class="text-sm mb-0 text-capitalize font-weight-bold">Usarios</p>
                                        <h5 class="font-weight-bolder mb-0">
                                            25
                                        </h5>
                                    </div>
                ...
                <!-- Estadistica de cuantas sucursales cuenta la empresa -->
                    ...
                    <div class="card mb-4">
                        <div class="card-body p-3">
                            <div class="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                <canvas id="chart-bars" class="chart-canvas chartjs-render-monitor" height="212" style="display: block; height: 169.6px; width: 328px; box-sizing: border-box;" width="410"></canvas>

                            </div>
                            <h6 class="ms-2 mt-4 mb-0"> Cantidad de Empleados por Sucursal </h6>
                                ...
                                <div class="row">
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Sucursal 1</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Sucursal 2</p>
                                        </div>
                                        <h4 class="font-weight-bolder">29</h4>
                                        <div class="progress w-75">
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Sucursal 3</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Sucursal 4</p>
                                        </div>
                                    ...
                                    <div class="col-3 py-3 ps-0">
                                        <div class="d-flex mb-2">
                                            ...
                                            <p class="text-xs mt-1 mb-0 font-weight-bold">Sucursal 5</p>
                                        </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-header pb-0">
                            ...
                            <p class="text-sm">
                                ...
                                <span class="font-weight-bold">Porcentaje</span> Año
                            </p>
                        </div>
                        <div class="card-body p-3">
                            <canvas id="chart-line" class="chart-canvas chartjs-render-monitor" height="375" width="610" style="display: block; height: 300px; width: 488px; box-sizing: border-box;"></canvas>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            © 2023,
                            Automotriz BOON S.A De C.V
                            <a href="https://www.creative-tim.com/product/soft-ui-dashboard" class="font-weight-bold text-capitalize" target="_blank"> (LMS)</a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link text-muted" target="_blank">Aspectos Legales</a>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link text-muted" target="_blank">Quejas y Sugerencias</a>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link text-muted" target="_blank">Pagina Oficial</a>
                            </li>
                            <li class="nav-item">
                                <a href="javascript:;" class="nav-link pe-0 text-muted" target="_blank">Aviso de Privacidad</a>
                            </li>
                        </ul>
                    </div>
                </div>
