    ...
    <form action="{{route('examenFinal')}}" method="POST" class="card col-11 mx-6">
        ...
        <div class="col-11">
            <div class="col-11 mx-6">
                <br>
                <h3 class="font-semi-bold">Información General del Examen Final</h3>
                <br>
                <input hidden type="text" rows="3" name="curso_id" value="{{$id}}" required>
                <div class="grid col-4">
                    <label for="titulo" class="block mb-2 font-bold text-gray-900 dark:text-white">Título del examen Final: <span class="text-red-500">*</span></label>
