<x-app title="Editar Examen">
    <form action="{{route('examenactualizado',$examen[0]->id_examen)}}" method="POST" class="card col-11 mx-6">
        ...
        <div class="col-11">
            <div class="col-11 mx-6">
                ...
                <div class="grid col-4">
                    ...
                    <input type="number" min="0" max="150" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="duracion" value="{{$examen[0]->duracion}}" id="duracion">
                </div>
                <br>
                ...
                <div class="grid col-11 " id="preguntasS" name="preguntas">
                    ...
                    <div class="pregunta">
                        ...
                        <input type="text" class="bg-gray-50 border border-gray-300 text-gray-900  rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="preguntas[{{ $pregunta->id_pregunta }}][titulo]" value="{{$pregunta->pregunta}}">
                        <br>
                        <label for="opciones1" class="block mb-2 font-semi-bold">Opciones: <span class="text-red-500">*</span></label>
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            @foreach($pregunta->opciones as $opcion)
                            <div class="flex items-center rounded">
                                <input type="text" name="preguntas[{{ $pregunta->id_pregunta }}][opciones][{{ $opcion->id_opciones }}][titulo]" value="{{ $opcion->opcion }}" class="mx-3 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Opción 1 *">
                            </div>
                            @endforeach
                        </div>
                        <div class="grid col-4">
        ...
        <div class="items-start mx-5">
            <button class="text-white bg-btn-primary hover:bg-btn-primary-light focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" id="agregarPregunta">
                <span>
            ...
            <button type="submit" class="text-white bg-btn-primary hover:bg-btn-primary-light focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 48 48">
                        <g fill="white">
