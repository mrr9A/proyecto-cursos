<x-app title="Lecciones">
        <div class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 items-center text-center">
            <h2 class="text-subtitle font-bold tracking-tight text-gray-900">BIENVENIDO ES MOMENTO DE AGREGAR LAS LECCIONES AL CURSO</h2>
        ...
        <form action="{{url('Lecciones')}}" method="POST" class="w-full p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700" enctype="multipart/form-data">
            ...
            <div class="flex justify-between px-4 items-center overflow-auto gap-3 mb-5 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
                ...
                <div class="flex justify-end px-4">
                    ...
                    <button class="text-white bg-btn-primary hover:bg-btn-primary-light focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 24 24">
            ...
            <input hidden type="text" rows="3" name="curso_id" value="{{$id}}" required><br>
            <div class="flex justify-between -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3">
                    <div class="w-full px-3">
                        ...
                        <input type="text" rows="3" value="{{ old('nombre') }}" name="nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="nombre" required>
                        @error('nombre') <span class="error text-incompleted">{{ $message }}</span> @enderror
                    </div><br>
                    <div class="px-3">
                        <label for="descripcion" class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Descripcion de la Lección <span class="text-red-700">*</span></label>
                        <textarea type="text" rows="8" name="descripcion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="descripcion" required>{{ old('descripcion') }}</textarea>
                    ...
                    <div class="col-11 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        <div class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25">
                            <div class="text-center">
                                ...
                                <p class="text-xs leading-5 text-gray-600 mt-9">Formatos Admitidos: PNG, JPG</p>
