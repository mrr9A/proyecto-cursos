...
class Usuarios extends Component
{
    ...
    public $nombre, $segundo_nombre, $apellido_paterno, $apellido_materno, $id_sgp, $id_sumtotal, $email, $password, $estado = 1, $rol, $puesto_id, $sucursal_id, $usuario_id , $fecha_alta_planta , $fecha_ingreso_puesto;
